...
async function handleFileOpen() {
  ...
  if (canceled) {
    ...
    // let blob;
    // fs.readFileSync(filePaths[0], (err, data) => {
    //   blob = data;
    // })
    return {
...
async function getFileByteBlob(filePath: string) {
...
app.whenReady().then(() => {
  ...
  ipcMain.handle("app:getFileByteBlob", (_event, args) => {
    getFileByteBlob(args.filePath);
  });
